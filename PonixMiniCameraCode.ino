...
void loop() {
  if (Firebase.ready() && (millis() - dataMillis > 5000 || dataMillis == 0)) {
    ...
    transform_write.document_transform.transform_document_path = "Towers/14frAKtXjQZUjDrrZrHz";
    ...
    field_transforms.fieldPath = "imageSnapshots";
